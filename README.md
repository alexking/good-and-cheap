...
The **code** (i.e. not recipes, recipe images) in this repository that is used to process recipes, etc., is released into the public domain via the [unlicense](http://unlicense.org). The CommonMark parser is [BSD3](https://github.com/jgm/CommonMark/blob/master/LICENSE).
